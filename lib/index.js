	  ...
	  render: function render() {
	    ...
	    var imageJewels = images.length > 0 ? images.map(function (img, i) {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_GalleryBox2.default, { size: jewelStyle.size, hlColor: jewelStyle.hlColor, hlSize: jewelStyle.hlSize, index: this.state.index, place: i, img: img })
	      );
	    }.bind(this)) : null;
